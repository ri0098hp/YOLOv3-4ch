...
if __name__ == "__main__":
    ...
    parser.add_argument("--names", type=str, default="data/default.names", help="*.names path")
    parser.add_argument("--weights", type=str, default="weights/best.pt", help="weights path")
    # input file/folder, 0 for webcam
    parser.add_argument("--source", type=str, default="data/test", help="source")
    parser.add_argument("--output", type=str, default="share/detect", help="output folder")  # output folder
